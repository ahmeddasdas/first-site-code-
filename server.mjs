...
//   const body = req.body; const id = req.params.id; if
//    (!body.name || !body.price || !body.description)
//     { res.status(400).send(` required parameter missing. example request body: { "name": "value", "price": "value", "description": "value" }`)
//      return; } try
//       { let data = await productModel.findByIdAndUpdate(id,
//          { name: body.name, price: body.price, description: body.description }, 
//          { new: true }).exec(); console.log('updated: ', data);
